                              ...
                              <div class="card-body">
                                 ...
                                 <div class="table-responsive mt-3">
                                    <table class="table align-middle mb-0">
                                       ...
                                       <tbody>
                                          <?php
                                             if(isset($_REQUEST["order"], $_REQUEST["restaurant"]))
                                             {
                                                 $id = $_REQUEST["order"];
                                                 ...
                                                 $result=mysqli_query($conn,"SELECT m.meal_id, m.meal_name, m.meal_image, m.meal_price 
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div class="d-flex align-items-center">
                                                   <div class="recent-product-img">
                                                      <img src="<?php echo $ADMIN_PRODUCT_IMG.$restaurant."/".$row['meal_image'];?>" alt="">
                                                   </div>
                                                   <div class="ms-2">
                                             ...
                                             <?php $total_of_all = $total_of_all + $row['meal_price'];?>
                                             <td>
