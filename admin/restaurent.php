						...
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
                                    ...
                                    <?php
                                        $count=1;
                                        $result=mysqli_query($conn,"select * from tbl_restaurant as r left join tbl_city as c on c.city_id=r.city_id");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="recent-product-img">
                                                    <img src="<?php echo $ADMIN_RESTAURANT_IMG."/".$row['restaurant_image'];?>" alt="">
                                                 </div>
                                            </td>
                                            <td>
                                                <a href='restaurent_detail.php?id=<?php echo $row['restaurant_id'];?>'><?php echo $row['restaurant_name'];?></a><br>
                                                Contact : <?php echo $row['restaurant_number'];?><br>
                                                Mail : <?php echo $row['restaurant_mail'];?><br>
                                            </td>
                                            <td>
                                                <a href="https://maps.google.com/?q=<?php echo $row['restaurant_latitude'].",".$row['restaurant_longitude']?>" target="_blank"><?php echo $row['restaurant_location'];?></a>
                                            </td>
