						...
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
                                    ...
                                    <?php
                                        $count=1;
                                        $result=mysqli_query($conn,"select * from tbl_foodbank as r left join tbl_city as c on c.city_id=r.city_id");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="recent-product-img">
                                                    <img src="<?php echo $ADMIN_FOODBANK_IMG."/".$row['foodbank_image'];?>" alt="">
                                                 </div>
                                            </td>
                                            <td>
                                                <a href='foodbank_detail.php?id=<?php echo $row['foodbank_id'];?>'><?php echo $row['foodbank_name'];?></a><br>
                                                Contact : <?php echo $row['foodbank_number'];?><br>
                                                Mail : <?php echo $row['foodbank_mail'];?><br>
                                            </td>
                                            <td>
                                                <a href="https://maps.google.com/?q=<?php echo $row['foodbank_latitude'].",".$row['foodbank_longitude']?>" target="_blank"><?php echo $row['foodbank_location'];?></a>
                                            </td>
