                              ...
                              <div class="card-body">
                                 ...
                                 <div class="table-responsive mt-3">
                                    <table class="table align-middle mb-0">
                                       ...
                                       <tbody>
                                          <?php
                                             if(isset($_REQUEST["inventory"], $_SESSION["restaurant_id"]))
                                             {
                                                 $id = $_REQUEST["inventory"];
                                                 $restaurant = $_SESSION["restaurant_id"];
                                             
                                                 $count=1;
                                                 $total_of_all = 0;
                                             
                                                 $result=mysqli_query($conn,"SELECT * FROM tbl_inventory_expiry AS ie LEFT JOIN tbl_inventory AS i ON i.item_id=ie.item_id WHERE ie.item_id = '".$id."'");
                                                 while($row=mysqli_fetch_array($result))
                                                 {
                                             ?> 
                                          <tr>
                                             ...
                                             <td>
                                                <div class="d-flex align-items-center">
                                                   <div class="ms-2">
                                                      <h6 class="mb-1 font-14"><?php echo $row['item_name'];?></h6>
                                                   </div>
                                                </div>
                                             </td>
                                             <td><?php echo $row['quantity'];?></td>
                                             <?php $total_of_all = $total_of_all + $row['quantity'];?>
