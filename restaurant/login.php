                        ...
                        <div class="card-body">
                           ...
                           <?php
                                    if(isset($_REQUEST["btnLogin"]))
                                    {
                                        ...
                                        $result = mysqli_query($conn,"select * from tbl_restaurant where restaurant_mail='".$_REQUEST["txtUser"]."' and restaurant_password='".$_REQUEST["txtPass"]."'");
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                if($row["restaurant_mail"]==$_REQUEST["txtUser"] && $row["restaurant_password"]==$_REQUEST["txtPass"])
                                                {
                              ...
                              <div class="mb-4 text-center">
						            <img src="../admin/assets/images/logo-img_res.png" width="180" alt="" />
				              </div>
