							...
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
									...
									if(isset($_SESSION["restaurant_id"]))
									{
										...
										$count=1;
										$result=mysqli_query($conn,"select * from tbl_inventory where restaurant_id ='".$restaurant_id."'");
									...
									<td>
										<div class="d-flex order-actions">
											<a href="inventory_detail.php?inventory=<?php echo $row['item_id'];?>" class="text-primary bg-light-primary border-0"><i class='fadeIn animated bx bx-show-alt' ></i></a>
										</div>
									</td>
									</tr>
									<?php }}?>
