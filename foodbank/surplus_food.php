						...
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
                                    ...
                                    <?php
                                        $count=1;
                                        $result=mysqli_query($conn,"select * from tbl_surplus_meals as sm left join tbl_meal as m on m.meal_id=sm.meal_id left join tbl_restaurant as r on r.restaurant_id=sm.restaurant_id");
